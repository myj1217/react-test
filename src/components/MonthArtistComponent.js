...
import art1Image from "./img/art1.jpg";
import art2Image from "./img/art2.jpg";

const MonthArtistComponent = () => {
  return (
    <div className="max-w-4xl mx-auto p-5 bg-gray-100 text-gray-800">
      <h1 className="text-4xl font-serif text-center mb-4">아리엘 리우</h1>
      ...
      <h2 className="text-3xl font-serif my-3">대표작품</h2>
      <div className="my-4 p-4 bg-white shadow-md">
        <h3 className="text-2xl font-serif mb-2">
          디지털 자연주의 (Digital Naturism)
        </h3>
